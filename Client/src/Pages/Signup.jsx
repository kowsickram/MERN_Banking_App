        ...
        <div className="max-w-md mx-auto p-2 flex items-center justify-center">
          {isSignUpSuccess ? (
            <div className="text-center">
              <p className="text-white text-2xl font-bold">Sign Up Successful</p>
              <button
                type="button"
            ...
            >
              <img src={logo} alt="#" className="w-32  object-center" />
              <br />
              <input
              ...
              <button
                ...
                className="bg-violet-500 text-white text-center px-4 py-2 mt-4 rounded-lg hover:bg-violet-600 cursor-pointer focus:outline-none focus:bg-violet-600"
              >
                Sign Up
              </button>
            </form>
